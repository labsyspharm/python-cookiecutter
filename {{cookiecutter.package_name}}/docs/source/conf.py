...
extensions = [
    ...
    # Enable this if you want to automatically document your command line interface written with click
    # 'sphinx_click.ext',
    "sphinx_automodapi.automodapi",
    "sphinx_automodapi.smart_resolver",
    # Enable this if you want to use $$ as shortcuts for writing latex inline in your documentation instead of :code:``
    # 'texext',
]
